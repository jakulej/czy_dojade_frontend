                                ...
                                <div className={'menu-item'}>
                                    {
                                        (!openProfile) ?
                                            <div>
                                                <button className={'menu-item-button1'} onClick={handleShowProfile}>
                                                    <p>
                                                ...
                                                {openProfile && <ProfileComponent onClose={handleShowProfile}/>}
                                            </div>
                                            :
                                            <div>
                                                <button className={'menu-item-button2'} onClick={handleCloseProfile}>
                                                    <p>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="16"
                                                             fill="currentColor"
                                                             className="bi bi-person-fill" viewBox="0 0 16 16">
                                                ...
                                                {openProfile && <ProfileComponent onClose={handleCloseProfile}/>}
                                            </div>
                                ...
                                <div className={'menu-item'}>
                                    {
                                        (!openSettings) ?
                                            <div>
                                                <button className={'menu-item-button1'} onClick={handleShowSettings}>
                                                    <p>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="16"
                                                             fill="currentColor"
                                                ...
                                                {openSettings && <SettingsComponent onClose={handleCloseSettings}/>}
                                            </div>
                                            :
                                            <div>
                                                <button className={'menu-item-button2'} onClick={handleCloseSettings}>
                                                    <p>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="16"
                                                             fill="currentColor"
                                                             className="bi bi-gear-fill" viewBox="0 0 16 16">
                                        ...
                                        <div className={'menu-item'}>
                                            {
                                                (!openLogin) ?
                                                    <div>
                                                        <button className={'menu-item-button1'}
                                                        ...
                                                        {openLogin && <LoginRegisterComponent onClose={handleCloseLogin}/>}
                                                    </div>
                                                    :
                                                    <div>
                                                        <button className={'menu-item-button2'}
